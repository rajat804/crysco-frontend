...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="group relative bg-white rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-emerald-100">
      {discount > 0 && (
      ...
      {/* Image */}
      <div className="relative h-[260px] bg-emerald-50 flex items-center justify-center overflow-hidden">
        <img
          src={image}
          alt={product.title}
          className="h-[220px] object-contain transition-all duration-500 group-hover:scale-105"
        />
      </div>
