...
const HeroBanner = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden max-h-[60vh] md:h-[65vh]">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* Overlay for desktop */}
          <div className="hidden md:absolute md:inset-0 md:bg-black/30"></div>

          {/* Content visible only on md+ */}
          <div className="hidden md:absolute md:inset-0 md:flex flex-col justify-center items-center text-center text-white px-6">
            <motion.h1
